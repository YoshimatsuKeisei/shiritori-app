...
import { BrowserDictionaryLoader, BrowserDictionarySession, dictionaryMetricsOptions, getConfiguredBrowserDictionaryBaseUrl, type DictionaryScope } from "./dictionary/index.js";
...
const productionSession = new BrowserDictionarySession(new BrowserDictionaryLoader(getConfiguredBrowserDictionaryBaseUrl(), undefined, undefined, dictionaryMetricsOptions(window.location.search)));
