...
export function VersusSetup({ values, onChange, onStart, loading, error }: Props) {
  ...
  return <section className="setup-panel" aria-labelledby="setup-title">
    ...
    <footer className="dictionary-credit">Dictionary data: <a href="https://www.edrdg.org/jmdict/j_jmdict.html" target="_blank" rel="noreferrer">JMdict</a> / <a href="https://www.edrdg.org/enamdict/enamdict_doc.html" target="_blank" rel="noreferrer">JMnedict</a> / <a href="https://www.edrdg.org/edrdg/licence.html" target="_blank" rel="noreferrer">EDRDG licence</a></footer>
  </section>;
}
