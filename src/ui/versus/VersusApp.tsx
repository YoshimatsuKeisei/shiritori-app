...
const session = new BrowserDictionarySession(new BrowserDictionaryLoader(getConfiguredBrowserDictionaryBaseUrl(), undefined, undefined, dictionaryMetricsOptions(window.location.search)));
